...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = """
            SELECT o.sinif, COUNT(i.kitapno) FROM ogrenci o\s
            LEFT JOIN islem i
            ON o.ogrno = i.ogrno
    ...
    //Her sınıftaki öğrenci sayısını bulun
    String QUESTION_8 = "SELECT o.sinif,COUNT(o.ad) FROM ogrenci o GROUP BY o.sinif;";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();
    //Her öğrencinin ad soyad karşısında okuduğu kitap sayısınını getirin
    String QUESTION_9 = """
            SELECT o.ad, o.soyad, COUNT(i.kitapno) FROM ogrenci o\s
            INNER JOIN islem i
            ON o.ogrno = i.ogrno
